...
uv run generate_course.py Machine_Learning.docx --title "machine_learning" --verbose --max-chapters 100 --custom-prompt custom_instructions.txt --parallel --max-workers 14 --min-delay 0.2 --max-delay 1.0 --max-retries 3 --fixed-chapters