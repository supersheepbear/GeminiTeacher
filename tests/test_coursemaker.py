...
def test_create_course_cascade(
    ...
    mock_get_default_llm.assert_called_once_with(0.0)
    mock_generate_toc.assert_called_once_with(
        content, llm=mock_llm, temperature=0.0, max_chapters=10, fixed_chapter_count=False, verbose=True
    )
    ...
    mock_generate_summary.assert_called_once_with(content, [chapter1, chapter2, chapter3], llm=mock_llm, temperature=0.0, verbose=True)
